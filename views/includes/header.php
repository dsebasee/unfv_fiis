...
<head>
  ...
  <title>Control de Asistencia | UNFV</title>
  <!-- base:css -->
      ...
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="?pagina=carreras">
            ...
            <span class="menu-title">Carreras / Sector</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="?pagina=estudiantes">
            ...
            <span class="menu-title">Nombres y Apellidos</span>
          </a>
        </li>
        <li class="nav-item">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="plantilla.php"><img src="<?php echo RUTA . 'assets/'; ?>images/logo_unfv.png" width="60" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href="plantilla.php"><img src="<?php echo RUTA . 'assets/'; ?>images/logo_unfv.png" width="30" alt="logo"/></a>
          </div>
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">Sistema de Control de Asistencia UNFV</h4>
